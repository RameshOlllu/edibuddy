  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Lottie.asset(
            'assets/animations/empty-education.json',
            height: 200,
          ),
          const SizedBox(height: 16),
          Text(
...
Widget _buildEducationForm() {
  ...
  items: _buildSpecializationItems(),
            ...
            _buildTextField(
              ...
              validators: [
                FormBuilderValidators.required(errorText: 'This field is required'),
                FormBuilderValidators.numeric(errorText: 'Enter a valid year'),
                FormBuilderValidators.min(1950, errorText: 'Year must be 1950 or later'),
                FormBuilderValidators.max(2030, errorText: 'Year must be 2030 or earlier'),
              ],
            ),
...
List<DropdownMenuItem<String>> _buildDegreeItems() {
  final educationLevel = _formKey.currentState?.fields['highestEducationLevel']?.value as String?;
